...
enum EDITOR_CHANGE_UNIT { CHANGE_BYTES, CHANGE_LINES, CHANGE_RANGE };
...
bool editor_parse(fz_context *ctx, vstack *stack, val command,
...
void editor_synctex(const char *dirname, const char *basename, int basename_len,
		    int line, int column);
